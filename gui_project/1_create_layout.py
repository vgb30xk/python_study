...
cmd_width = ttk.Combobox(frame_option, state="readonly",
...
cmd_space = ttk.Combobox(frame_option, state="readonly",
...
cmd_format = ttk.Combobox(frame_option, state="readonly",
